  ...
  home: {
    ...
    score: {
      ...
      shared: {
        ...
        whatIsThis: "Shared from Saathban — a score only. Nothing else from their day is here.",
      ...
      share: {
        ...
        toastCommunityDone: "Your score is on the community board ✓",
        toastPeopleSentOne: "Told one person ✓",
        notifyTitle: "{name} shared their day",
        notifyTitleAnon: "A friend shared their day",
        notifyBody: "{points} points so far today.",
        toastPeopleSent: "Told {n} people ✓",
        toastPeopleNone: "Nobody to tell just yet — your circle and your conversations both live in Settings.",
        toastLinkCopied: "Link copied ✓ It shows your score only, and stops working in 7 days.",
        toastLinkShown: "Here is your link — it shows your score only, and stops working in 7 days.",
        alreadyCommunity: "Already on the board today.",
        shareFailed: "That didn't go through. Nothing was shared.",
