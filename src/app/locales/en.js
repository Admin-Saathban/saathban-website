...
const en = {
  ...
  settings: {
    ...
    dailyLog: {
      ...
      /* The meal categories the log asks about one at a time, and the
         movement options it offers — both the person's own lists. */
      meals: {
        title: "Your meals",
        hint: "The meals your log asks about, one at a time. Rename any, remove the ones you don't have, add your own — Chai & snacks, a late supper, whatever your day has.",
        addPlaceholder: "Add a meal",
        addCta: "Add meal",
        empty: "No meals on your log yet — add one below.",
      },
      movement: {
        title: "Your movement",
        hint: "What your log offers when you note some movement. Rename any, remove what you never do, add your own.",
        addPlaceholder: "Add something you do, like swimming",
        addCta: "Add",
        empty: "Nothing here yet — add something you do below.",
      },
      list: {
        rename: "Rename",
  ...
  home: {
    ...
    log: {
      ...
      sumDiet: "{n} logged",
      /* The meal flow: one category, one question at a time. Portions are
         a record, never a target — no totals, no pass or fail. */
      mealQ: "Did you have {name}?",
      yes: "Yes",
      no: "No",
      mealYes: "yes",
      mealNo: "no",
      notYet: "Not yet",
      mealsProgress: "{n} of {total}",
      portionsHint: "Roughly how many portions? Leave any of these blank.",
      portions: { fibre: "Fibre", protein: "Protein", carbs: "Carbs" },
      portionFewer: "One portion less of {what}",
      portionMore: "One portion more of {what}",
      portionAria: "{what}: {n}",
      portionBlankAria: "{what}: left blank",
      nextMeal: "Next meal",
      mealsFinish: "That's all",
      mealsDoneLine: "Today's meals are noted.",
      mealsNote: "Just a record for you — never a diet plan, never a target.",
      mealsEmpty: "Your log has no meals to ask about yet. Add one here, or in Settings.",
      movementEmpty: "Nothing to choose from yet. Add something you do here, or in Settings.",
      addMealPh: "Add a meal, like Chai & snacks",
      addMovementPh: "Add something you do, like swimming",
      addToList: "Add",
      sumGlassOne: "1 glass",
    ...
    score: {
      ...
      shared: {
        loading: "Opening…",
        title: "Their day so far",
        titleNamed: "{name}'s day so far",
        logsOne: "From one thing logged today.",
        logsMany: "From {n} things logged today.",
        expiresOn: "This link stops working on {date}.",
        whatIsThis: "Shared from Saathban — a summary only. Nothing else from their day is here.",
        goneTitle: "This link has expired",
        goneBody: "Shared links last seven days. Ask them for a fresh one whenever you like.",
        errorTitle: "That didn't open",
        errorBody: "Something went wrong on the way. Please try the link again in a moment.",
      },
    },
  },
  ...
  fam: {
    ...
    card: {
      ...
      loggedTodayNamed: "✓ {name} logged today",
  ...
  community: {
    ...
    feed: {
      ...
      mutedToast: "Muted. Nothing they do will notify you, and their posts are hidden. They won't know.",
    ...
    shares: {
      ...
      scoreTitle: "A day logged",
      scoreLineN: "{n} things logged that day.",
      scoreLineNOne: "1 thing logged that day.",
    ...
    connect: {
      ...
      intro:
        "Find people on Saathban by name and ask to connect. They decide, quietly — nothing is shared either way until you're both happy.",
      searchLabel: "Search by name",
      searchPlaceholder: "A name — three letters or more…",
      noResults: "Nobody found by that name — try another spelling, or the start of their first name.",
  ...
  admin: {
    ...
    flag: {
      specific_person_request: "Asking to be matched with a specific named person",
      id_reluctance: "Reluctance to provide ID or references",
      availability_mismatch: "Availability inconsistent with stated job or study",
      off_platform_contact: "Early attempt to move contact off-platform",
    },
    doc: {
      police: "Police character certificate",
      cnic: "Clearer CNIC photo",
      occupation: "Proof of occupation or enrolment",
      selfie: "Updated selfie",
    },
    media: {
      voiceTitle: "Reported voice recording",
      imageTitle: "Reported image",
      handedOver: " · copy handed over by the reporter",
      opening: "Opening…",
      listen: "Listen to it",
      look: "Look at it",
      failed: "That file could not be opened — it may have been deleted since the report.",
      alt: "Reported",
    },
    queue: {
      emptyTab: "Nothing waiting under “{status}” right now.",
      loading: "Loading applications…",
      applicant: "Applicant",
      city: "City",
      languages: "Languages",
      applied: "Applied",
      refsCalled: "References called",
      redFlags: "Red flags",
      status: "Status",
      enter: "Open",
    },
    questionsQueue: {
      loadFailed: "The questions could not be loaded.",
      replyFailed: "The reply did not send. Please try again.",
      loading: "Loading…",
    },
    broadcast: {
      sendFailed: "The broadcast did not send. Please try again.",
      title: "Title",
      message: "Message (optional)",
      reason: "Reason (for the audit log — not shown to anyone who receives it)",
      accountsOnly: "{role} accounts only",
    },
    mod: {
      reasonLabel: "reason:",
      hide: "Hide content",
      surface: {
        ...
        dm_request: "A message request",
        dm_conversation: "A conversation",
      },
      suspendAuthor: "Pause this account",
      suspendConfirm: "Yes, pause {name}'s account",
      suspendNeedsReason: "Write a short reason in the note first — it is kept with the decision.",
      suspended: "{name}'s account is paused. It is on the record.",
      suspendAdminRefused: "Only a super-admin can pause a staff account.",
      suspendFailed: "That didn't go through. Please try again.",
      loadFailed: "The queue did not load. Please try again in a moment.",
      saveFailed: "That decision did not save. Please try again.",
      hiddenNote: "Content hidden.",
      hideFailed: "It could not be hidden — the content may already be gone.",
      loading: "Loading…",
      hoursOld: "{n}h old",
      overdue: " — past the response target",
      reportedAt: "· reported {when}",
      noExcerpt: "(nothing was captured with this report)",
      by: "By",
    ...
    app: {
      ...
      refsCalled: "{done} of {total} called",
      docStatus: { awaiting: "waiting", received: "received", declined: "declined" },
      backToQueue: "← Buddy review queue",
      appliedOn: "Applied {when} · {city} · speaks",
      dobAge: "{when} · age {age}",
      commitMonths: "{n} months",
      criminalRecord: "Criminal record disclosed:",
      yes: "Yes",
      no: "No",
      consentedCert: "Consented to police character certificate:",
      acceptedConduct: "Accepted code of conduct:",
      calledOn: "✓ Called {when}",
      appliedShort: "Applied {when}",
      uploadedByApplicant: "uploaded by applicant",
      requestedOn: "Requested {when}",
      responseOn: "response {when} —",
      privateBucket: "Private bucket",
      loading: "Loading…",
      saveFailed: "That did not save. Please try again.",
      legalName: "Legal name (as on CNIC)",
      cnicNumber: "CNIC number",
      dob: "Date of birth",
      phone: "Phone",
      cnicPhoto: "CNIC photo",
      selfie: "Selfie at signup",
      occupation: "Occupation / institution",
      city: "City",
      areas: "Reachable areas",
      languages: "Languages spoken — the most important matching field",
      hours: "Weekly hours offered",
      commitment: "Commitment",
      experience: "Experience with seniors or caregiving",
      noneDeclared: "None declared",
      bothRefs: "Both reference calls must be recorded before probation",
      suspendNote: "Suspended from admin review.",
      reinstateNote: "Reinstated after review.",
    },
    loadFailed: "The applications could not be loaded.",
  ...
  milestones: {
    ...
    intro: "Badges here celebrate one thing only: you showing up, in your own way. Nothing on this page compares you with anyone.",
    days: {
      label: "days with Saathban",
      line: "Every day you showed up. This never resets.",
    },
    arc: {
  ...
  msg: {
    ...
    newChat: {
      ...
      /* Invite folded into New chat (Messages rework): the door for somebody who is not here yet. */
      inviteTitle: "Not here yet?",
      inviteBody: "Send someone a link to join you on Saathban.",
    ...
    req: {
      ...
      /* Report only reports now; Block is its own choice on the card. */
      reportedNote: "Reported. The Saathban team will read {name}'s message. Nothing else has changed — you can still accept, say not now, or block.",
      block: "Block {name}",
    },
    menu: {
      archived: "Archived chats",
      blocked: "Blocked and muted",
    ...
    blocked: {
      empty: "You have not blocked or muted anyone.",
      unblock: "Unblock",
      blockedTitle: "Blocked",
      mutedTitle: "Muted",
      unmute: "Unmute",
    },
    /* The thread's own menu — Block, Mute, Archive and Report together (Messages rework). */
    thread: {
      more: "More",
      menuLabel: "More for your chat with {name}",
      menuTitle: "Your chat with {name}",
      close: "Close",
      back: "Go back",
      failed: "That did not go through. Please try again.",
      mutedChip: "Muted",
      mute: "Mute {name}",
      muteSub: "Nothing {name} does will notify you, and their posts leave your feed. This chat stays open. They won't know.",
      unmute: "Unmute {name}",
      unmuteSub: "You will be told about {name} again, and see their posts.",
      mutedToast: "{name} is muted. They won't know.",
      unmutedToast: "{name} is unmuted.",
      archive: "Archive this chat",
      archiveSub: "It moves out of Chats. Nothing is deleted.",
      unarchive: "Bring back to Chats",
      unarchiveSub: "It goes back into Chats, in its place.",
      archivedToast: "Moved to Archived chats, in Menu.",
      unarchivedToast: "Back in Chats.",
      report: "Report this conversation",
      reportSub: "Tell the Saathban team something here is not right.",
      reportTitle: "Report your chat with {name}?",
      reportBody: "The Saathban team will look at it. {name}'s last few messages are sent with the report so the team can see what happened. {name} is not told.",
      reportConfirm: "Send the report",
      reportedToast: "Sent. The Saathban team will look at it.",
      block: "Block {name}",
      blockSub: "They won't be able to write to you.",
      blockTitle: "Block {name}?",
      blockBody: "{name} will not be able to write to you, and you will not see each other anywhere on Saathban. They are not told. You can unblock them any time from Messages, in Menu, under Blocked and muted.",
      blockConfirm: "Yes, block {name}",
      blockedToast: "{name} is blocked. You can undo this in Menu.",
      blockedHere: "You have blocked {name}, so this chat is closed.",
      unblockHere: "Unblock {name}",
  ...
  posts: {
    ...
    shareCardHint: "This is how it will look in the feed. Change the words, clear them, or go back without posting.",
    share: "Share",
    photo: "Photo",
    ...
    menu: {
      ...
      hide: "Hide this post",
      /* The one Mute (0145). The sub-line says what it does and answers
         the fear that stops people using this control at all. It is
         true, and it is reversible. */
      mute: "Mute {name}",
    ...
    editCancel: "Leave it as it was",
      muteSub: "Their posts leave your feed and nothing they do will notify you. Your chat stays open. They won't know.",
      report: "Report this",
    },
  },
  people: {
    ...
    thread: {
      ...
      quotePhoto: "Photo",
      quoteGame: "A game",
      /* The game link under a table that is no longer open. */
      gameFinished: "This game has finished — see the board",
      gameCancelled: "This game did not go ahead",
      gameLink: "A game — open it",
  ...
  ludo: {
    ...
    settings: {
      ...
      sound: "Sound",
      playing: "Playing",
      hints: "Show move hints",
      hintsNote:
        "Short lines telling you what to tap. Off by default \u2014 turn them on if you'd like the game to talk you through a turn.",
      table: "This table",
      rulebook: "Rulebook",
    ...
    book: {
      ...
      capturing: {
        ...
        takingAJota: "A jota can take a jota, and both of those gotis go home together \u2014 but it is still ONE extra turn, not two. A jota can also take a lone goti. What it cannot do is take somebody standing on a star.",
        notOnStar: "You cannot take anybody who is standing on a star.",
      },
      jota: {
        title: "Jota (pairs)",
        what: "Two of your own gotis on one square make a jota. A lone goti cannot take a jota \u2014 it takes a jota to break one.",
        half: "A jota travels together, at half the number you threw \u2014 so a six moves the pair three squares. Only an even number can move one.",
        breaking: "You may move one of the two alone instead, and the pair is broken.",
        passing: "A lone goti cannot pass an enemy jota: it stops short, and that number cannot be used. A jota of your own can pass anything, and a jota standing on a star blocks nobody.",
        whenTaken: "When a jota is taken, both of its gotis go home and both start again.",
      },
      teams: {
        title: "Teams (2 v 2)",
        partners: "Four players, two teams. Your partner is the seat ACROSS the board from you, never the one beside you.",
        noTakingPartners: "You can never take your partner. Until your numbers are shared you cannot even land on them \u2014 the move is not offered.",
        sharing: "Once BOTH of you have taken somebody, your numbers belong to the team: either of you may spend a roll on either of your gotis. Both circles say so when it happens.",
        mixed: "After that, one of your gotis and one of your partner's may stand on the same square as a mixed jota, and travel together at half the number \u2014 exactly like a jota of one colour. Before that they simply stand side by side, and an enemy can take either one of them.",
        mixedTaken: "A mixed jota is a jota: only another jota can break it. It travels together only while both gotis can still stand on the same square, so it splits when one of you turns into your home column.",
      },
      home: {
        title: "Getting home",
    ...
    celebrate: {
      ...
      warmth: "Everyone at this table played, and that is the part worth keeping.",
  ...
  games: {
    ...
    home: {
      ...
      puzzleDaysSolved: "{n} days solved",
      puzzleDaysSolvedOne: "1 day solved",
    ...
    puzzle: {
      ...
      hintMore: "Another hint, please",
      hintLabel: "Hint {n} of {total}",
      hintFree: "There are {n} hints, one at a time. Taking them changes nothing — hints aren't counted anywhere.",
      hintFreeOne: "There's a hint if you'd like one. Taking it changes nothing — it isn't counted anywhere.",
      hintsAll: "That's every hint for today — the last one is very close.",
  ...
  /* ─── Shared streaks (routes/streaks/, 0140) ───
     A streak is a person's own run, sent to people they chose. Nobody is
     ranked, nothing is automatic, and a missed day is asked about kindly
     and never decided for them. The words sound like family. */
  streaks: {
    pillNew: "+ streak",
    pillAria: "{item} streak, {n} days. Send it",
    pillNewAria: "Start a streak for {item}",
    listJoin: ", ",
    noun: {
      water: "water",
      sleep: "sleep",
    ...
    units: { glasses: "glasses", hours: "hours", minutes: "minutes", times: "times" },
    days: {
      label: "Your days",
      count: "{n} days with Saathban",
      countOne: "1 day with Saathban",
      sub: "Every day you showed up. This never resets.",
      share: "Share",
    },
    create: {
      title: "Create a {noun} streak",
      sub: "You'll be able to send it to people you choose, once a day.",
      numberTitle: "A number each day",
      numberSub: "Set a range — a day counts when you're inside it. Good for glasses of water, minutes of movement, hours of sleep.",
      yesNoTitle: "Just yes or no",
      yesNoSub: "A day counts if you did it at all. Good for medicine, a walk, a call home.",
      from: "At least",
      to: "At most",
      perDay: "{unit} a day",
      lower: "Lower “{which}”",
      raise: "Raise “{which}”",
      chooseWho: "Choose who it goes to",
      keepPrivate: "Keep it private for now",
      whoTitle: "Send {noun} to",
      whoSub: "You can change this any time. They'll only see this one streak, nothing else from your log.",
      family: "Family",
      friends: "Friends",
      nobody: "There's nobody to choose from yet, and that's perfectly fine. The streak is yours to keep, and people can be added whenever you like.",
      create: "Create the streak",
      back: "Back",
      loading: "Finding your people…",
      made: "Your {noun} streak is made ✓",
      madePrivate: "Your {noun} streak is made — just for you for now ✓",
      failed: "That didn't go through, so nothing was made. Please try again.",
    },
    send: {
      title: "Send your {noun} streak",
      sub: "Going to the people you chose. Tap a name to leave them out today.",
      already: "Already sent today",
      leftOut: "Left out today",
      sendMany: "Send to {n} people",
      sendManyOne: "Send to 1 person",
      allHaveIt: "Everyone you chose already has it today.",
      change: "Change who gets this",
      seeGroup: "See who's in today",
      justYou: "This streak is just for you for now. Whenever you'd like someone to see it, choose them here.",
      notLogged: "Today's {noun} isn't logged yet, so there's nothing to send just now.",
      outOfRange: "Today's {noun} is {value} {unit}. Your range is {min}–{max}, so today doesn't count yet.",
      logNow: "Log my {noun} now",
    ...
    inbox: {
      sent: "{name} sent you a {noun} streak",
      runTap: "🔥 {n} days · tap to log your {noun} and send yours back",
      runTapOne: "🔥 1 day · tap to log your {noun} and send yours back",
      runReplied: "🔥 {n} days · you replied",
      runRepliedOne: "🔥 1 day · you replied",
      groupsLabel: "Streak groups",
      groupTitle: "{item} — {n} people",
      groupLine: "{sent} sent today · {left} still to go",
      groupAll: "Everyone has sent today",
      groupNone: "Nothing sent yet today",
    },
    window: {
      title: "{item} with {name}",
      isOn: "{name} is on",
      daysOf: "days of {noun} in a row",
      daysOfOne: "day of {noun} — the start of a run",
      yours: "Your {noun} today",
      range: "Your range: {min}–{max} {unit}",
      counts: "✓ Today counts",
      notYet: "Not in your range yet",
      recordSend: "Record and send back to {name}",
      sentBack: "✓ Sent back to {name} today",
      sending: "Sending…",
      more: "Send my {noun} streak to more people",
      onlyThis: "{name} won't see the rest of your log — only {noun}.",
      notLogged: "Record today's {noun} above first, then it can go back to {name}.",
      outOfRange: "Today's {noun} is {value} {unit}, and your range is {min}–{max}. Once it's in range, it can go back to {name}.",
      trackerNotYours: "This is {name}'s own tracker, so there's nothing of yours to record for it here.",
      gone: "This streak isn't here any more.",
      back: "Back",
    ...
    group: {
      title: "{item} — {n} people",
      you: "You",
      sentMorning: "🔥 {n} · sent this morning",
      sentAfternoon: "🔥 {n} · sent this afternoon",
      ...
      month: "This month",
      daysSent: "Days sent",
      daysSentSub: "Not in a row — just how many days each of you showed up.",
      barAria: "{name}: {n} days",
      barAriaOne: "{name}: 1 day",
      gone: "This group isn't here any more.",
    },
    nudge: {
      title: "A nudge for {name}",
      sub: "These are your words — change anything you like before it goes.",
      titleLabel: "What they see first",
      bodyLabel: "And underneath",
      defaultTitle: "{me} is thinking of you",
      defaultTitleAnon: "Someone is thinking of you",
      defaultBody: "How's your {noun} today? I've sent mine — send yours when you get a moment.",
      send: "Send the nudge",
      notNow: "Not now",
      sent: "Your nudge is on its way to {name} ✓",
      alreadySent: "{name} has already sent today — no nudge needed.",
      alreadyNudged: "You've already nudged {name} today.",
      failed: "That didn't send. Please try again.",
    },
    missed: {
      noLog: "Yesterday had no {noun} logged",
      outOfRange: "Yesterday's {noun} didn't reach your range",
      stillHere: "Your run is still here, if you want it",
      restTitle: "Use a rest day",
      restOne: "You have 1 left. A new one arrives every seven days.",
      useRest: "Use my rest day",
      restart: "Let it rest and start again",
      either: "Either way, your {n} days stay exactly as they are. Nobody is told which you chose.",
      eitherOne: "Either way, your 1 day stays exactly as it is. Nobody is told which you chose.",
      rested: "Rest day taken. Your run carries on ✓",
      restarted: "It's resting now. Today starts it fresh ✓",
      noneLeft: "This week's rest day has already been used.",
      nothing: "There's nothing to settle here any more.",
    },
    share: {
      sheetTitle: "Share from your days",
      daysLabel: "days with Saathban",
      daysLabelOne: "day with Saathban",
      daysShare: "Share this",
      runLine: "🔥 {n} days in a row · longest {longest}",
      runLineOne: "🔥 1 day · longest {longest}",
      resting: "Starting fresh · longest {longest}",
      share: "Share",
      shareAria: "Share {item}",
      goodDay: "Today was a good day",
      goodDaySub: "Tell your people why, if you want to.",
      privacy: "Your family sees that you logged today — never your numbers, unless you send them.",
      daysBody: "Every one of these days, in my own way.",
      streakBody: "Keeping this going, one day at a time.",
    },
    feed: {
      daysLine: "days with Saathban",
      daysLineOne: "day with Saathban",
      daysSub: "Every day, showing up. The count never resets.",
      streakLine: "🔥 {n} days of {noun} in a row",
      streakLineOne: "🔥 The first day of {noun} — a run begins",
      streakLongest: "Longest run: {n} days",
      goodDay: "Today was a good day",
    },
  },
  ...
  history: {
    /* §14 — a journey, not a dashboard. Nothing here is a score:
       ...
       for a points total — there are no points — and the days with
       Saathban are said once, in the share block at the top. */
    header: {
  ...
  /* Sharing shows what goes out, to whom, and where it went (0120). */
  share: {
    namesAnd: "{list} and {last}",
    namesMore: "{list} and {n} more",
    scoreBody: "Showing up for my day.",
    puzzleBody: "Today's riddle is a good one — have a go.",
    previewHint: "How it will look in the feed",
    goesTo: "This goes to {names}.",
    loadingNames: "Finding who this goes to…",
    nobodyYet: "There is nobody to send this to yet. Your circle and your conversations both live in Settings.",
    titleLabel: "What they will see first",
    bodyLabel: "And underneath",
    sendCta: "Send",
    sending: "Sending…",
    notNow: "Not now",
    ...
    sentTo: "Sent to {names}.",
    sentCount: "{n} of them get notifications like this.",
    sentCountOne: "1 of them gets notifications like this.",
    sentNone: "None of them get notifications like this right now, so nobody was notified.",
    openPage: "See the page they will open",
    linkPreview: "This is what the link shows. Nothing else from your day is on it.",
    makeLinkCta: "Make the link",
    linkReady: "Here is your link. It stops working after 7 days.",
    copyCta: "Copy the link",
    copied: "Copied",
    riddleTitle: "{name} cracked today's riddle",
    riddleTitleAnon: "A friend cracked today's riddle",
    riddleBody: "Have you had a go yet? It's a good one.",
    alreadyTold: "You already told your people about today's riddle.",
    tellHeading: "Tell your people",
  },
  feedback: {
    savedState: "Saved ✓",
    saveCta: "Save",
    ...
    linkNotCopied: "Your phone would not let us copy it. You can share the post from its page instead.",    deleteFailedStay: "That post was NOT deleted — it is back on your list. Please try again.",
