...
const MEMBER_COLS =
  "id, member_id, is_sos_contact, sos_order, can_see_mood, can_see_health, can_manage_reminders, can_configure_daily_log, quiet_days_notice, location_access, created_at";
