...
export const STRINGS = {
  en: {
    ...
    /* One Mute, for a person (0145) — the same Mute as a chat's menu
       and a post's menu. */
    mutePerson: (name) => `Mute ${name}`,
    mutePersonSub: "Nothing they do will notify you, and their posts leave your feed. Your chat stays open. They won't know.",
    mutedPerson: (name) => `${name} is muted. They won't know. You can unmute here, or in Messages under Blocked and muted.`,
    unmutePerson: (name) => `Unmute ${name}`,
    someone: "this person",
    ...
    reportKind: { post: "A post", comment: "A comment", dm_message: "A message", dm_request: "A message request", dm_conversation: "A conversation", park_board: "A board message", group: "A group", group_post: "A group post" },
  ...
  ur: {
    ...
    mutePerson: (name) => `${name} کو خاموش کریں`,
    mutePersonSub: "ان کی کسی بات کی اطلاع آپ کو نہیں آئے گی، اور ان کی باتیں آپ کی فیڈ سے ہٹ جائیں گی۔ گفتگو کھلی رہے گی۔ انہیں پتا نہیں چلے گا۔",
    mutedPerson: (name) => `${name} خاموش ہیں۔ انہیں پتا نہیں چلے گا۔ آپ یہیں سے، یا «پیغامات» میں «بلاک اور خاموش» سے واپس بدل سکتے ہیں۔`,
    unmutePerson: (name) => `${name} کی خاموشی ختم کریں`,
    someone: "اس شخص",
    ...
    reportKind: { post: "ایک بات", comment: "ایک تبصرہ", dm_message: "ایک پیغام", dm_request: "پیغام کی ایک درخواست", dm_conversation: "ایک گفتگو", park_board: "بورڈ کا ایک پیغام", group: "ایک گروپ", group_post: "گروپ کی ایک بات" },
